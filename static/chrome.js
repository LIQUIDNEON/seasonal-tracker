(function () {
  if (!document.getElementById('st-layout-css')) {
    ...
    css.textContent = document.getElementById('st-layout-css') ? '' : [
      ...
      'body.layout-row .week-strip .day-col{width:100%!important;overflow:hidden!important;}',
  ...
  function isBar() { const l = state.settings.layout; return l === 'stacks' || l === 'bar'; }
